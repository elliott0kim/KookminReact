                                ...
                                <div className="mento-info mento-info-summary recommand-box circle-direct card min-card" style={{marginBottom:"10px"}}>
                                    <div className="card-content">
                                        <div style={{flex:"1 0 auto"}}>
                                            ...
                                            <div className='li-chk'>
                                                <img src="/images/circle-direct.svg" alt="circle-direct" className='ico-chk'/>
                                                <p className='mento-info mento-info-summary recommand-box-visual-txt'>대면</p>                                                <p className='mento-info mento-info-summary recommand-box-visual-txt' style={{fontSize:"15px", maxWidth:"100%",  width:"100%", marginBottom:"10px", wordWrap: 'break-word', wordBreak: 'break-all', whiteSpace: 'normal', overflowWrap: 'break-word'}}>대면</p>
                                            </div>
                                        </div>
                                        <div>
                            ...
                            <div className="mento-info mento-info-summary recommand-box">
                                <div className="mento-info mento-info-summary recommand-box circle-direct card min-card" style={{marginBottom:"10px"}}>
                                    <div className="card-content">
                                        ...
                                        <div>
                                            <button onClick={() => handleButtonNext(3)} className="mento-info mento-info-summary recommand-box btn btn-payment">
                                            ...
                                            <button onClick={() => handleOpenDetail(3)} className="mento-info mento-info-summary recommand-box btn btn-detail">
                                                <p className='mento-info mento-info-summary recommand-box-visual-txt'>자세히 알아보기</p>
                                            </button>
                                        </div>
                                    </div>
                                    ...
                                    <div className="mento-info mento-info-summary recommand-box circle-direct card card-detail">
                                        <div className='card-content'>
                                            ...
                                            <div>
                                                ...
                                                <button onClick={() => handleOpenDetail(3)} className="mento-info mento-info-summary recommand-box btn btn-detail-close">
                                                    <p className='mento-info mento-info-summary recommand-box-visual-txt'>상세정보 닫기</p>
                                                </button>
                                            </div>
                                        </div>
