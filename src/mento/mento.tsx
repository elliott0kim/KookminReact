...
/* 페이지 로그 수집부분 end */
    ...
    const barChart = () => (
        ...
        <ResponsiveBar 
            ...
            borderRadius={8}
            theme={{text:{fontSize:13, fontFamily: "Noto Sans KR", fontStyle: 'normal', fontWeight: 700}, tooltip:{container:{ color: "#333333", fontSize: 12}}}}
            labelTextColor="#795858"
            label={d => (
                <>
                <tspan dx="0" dy="-0.5em">{d.id}</tspan>
                <tspan dx="-1.1em" dy="1.2em">{d.value}</tspan>
                </>
            )}
                ...
                <div className="content-area mento-info-summary">
                        ...
                        <div className="summary-area">
                            ...
                            <div className="summary-bottom">
                                ...
                                <div className="btns-wrap bottom-btns-wrap">
                                    <div>
                                        <button onClick={() => handleButtonClick(selectedMentoInfo, 0)} disabled={loading} className="btn btn-primary" style={{fontSize:'20px'}}>
                                        {loading ? '로딩 중...' : '예약하기'}
                                        </button>
                                        {/* 오류 메시지 표시 */}
                            ...
                            {selectedMentoInfo.recommendContent.map((recommandText, index) => (
                                ...
                                <div className="recommand-box">
                                    ...
                                    <img src="/images/circle-direct.png" alt="circle-direct" />
                                    <p className="recommand-box-visual-txt">{recommandText}</p>
                                    </div>
                                </div>
                                </div>))}
                                <div className='recommand-bottom-layout'>
                                    <div className='recommand-bottom-visual-txt'><br />위 내용에 해당되신다면<br />지금 바로 멘토링을 신청하세요!</div>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div className='new-mento-intro'>
                        <div className='intro-card'>
                            <br />
                            <div className='visual-txt'>{selectedMentoInfo.nickname} 님을 소개할게요.</div>
                            ...
                            <div className='profile-card'>
                                ...
                                <div className='right'><div className='visual-txt'>{selectedMentoInfo.introduceContent}</div></div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div className="container-fluid">
                        <br /><br /><br /><br /><br />
                        <p className="visual-txt" style={{fontSize:"26px"}}>다른분들은 {selectedMentoInfo.nickname}에게<br /> 이런 주제를 많이 물어봤어요.</p>
                        <div className="summary-area">
                            <div className="summary-top" style={{paddingBottom:"0px"}}>
                            </div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", flexDirection:"column", fontSize:"13px"}}>
                                질문 주제 1위
                            </div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", flexDirection:"column", fontSize:"24px", color:"#F68536", fontFamily:"Noto Sans KR", fontStyle:"normal" ,fontWeight:"900", paddingBottom:"0px", marginBottom:"0px"}}>
                                {questionList[0]["category"]} {Math.floor((questionList[0]["count"]/totalQuestionCount)*100)}%
                            </div>
                            <div style={{height:"100px"}}>{barChart()}</div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", justifyContent: "center", flexDirection:"row", fontSize:"13px"}}>
                                <div style={{padding:"0 18px 0 0"}}>차트</div>
                                <div style={{padding:"0 18px 0 18px"}}>질문 종류</div>
                                <div style={{padding:"0 18px 0 18px"}}>빈도</div>
                                <div style={{padding:"0 0 0 18px"}}>비중</div>
                            </div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", justifyContent: "center", flexDirection:"row", fontSize:"16px",  fontFamily:"Noto Sans KR", fontStyle:"normal" ,fontWeight:"900"}}>
                                <div style={{margin:"0 0 0 20px", width: "24px", height: "24px", borderRadius:"8px", backgroundColor:"#F68536"}}></div>
                                <div style={{padding:"0 30px 0 50px"}}>{questionList[0]["category"]}</div>
                                <div style={{padding:"0 20px 0 10px"}}>{questionList[0]["count"]}건</div>
                                <div style={{padding:"0 10px 0 20px"}}>{Math.floor((questionList[0]["count"]/totalQuestionCount)*100)}%</div>
                            </div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", justifyContent: "center", flexDirection:"row", fontSize:"16px",  fontFamily:"Noto Sans KR", fontStyle:"normal" ,fontWeight:"900"}}>
                                <div style={{margin:"0 0 0 20px", width: "24px", height: "24px", borderRadius:"8px", backgroundColor:"#FFC49B"}}></div>
                                <div style={{padding:"0 30px 0 50px"}}>{questionList[1]["category"]}</div>
                                <div style={{padding:"0 20px 0 10px"}}>{questionList[1]["count"]}건</div>
                                <div style={{padding:"0 10px 0 20px"}}>{Math.floor((questionList[1]["count"]/totalQuestionCount)*100)}%</div>
                            </div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", justifyContent: "center", flexDirection:"row", fontSize:"16px",  fontFamily:"Noto Sans KR", fontStyle:"normal" ,fontWeight:"900"}}>
                                <div style={{margin:"0 0 0 20px", width: "24px", height: "24px", borderRadius:"8px", backgroundColor:"#FFDEC7"}}></div>
                                <div style={{padding:"0 30px 0 50px"}}>{questionList[2]["category"]}</div>
                                <div style={{padding:"0 20px 0 10px"}}>{questionList[2]["count"]}건</div>
                                <div style={{padding:"0 10px 0 20px"}}>{Math.floor((questionList[2]["count"]/totalQuestionCount)*100)}%</div>
                            </div>
                            <div className="summary-bottom" style={{display:"flex", alignItems:"center", justifyContent: "center", flexDirection:"row", fontSize:"16px",  fontFamily:"Noto Sans KR", fontStyle:"normal" ,fontWeight:"900"}}>
                                <div style={{margin:"0 0 0 20px", width: "24px", height: "24px", borderRadius:"8px", backgroundColor:"#F7F7F7"}}></div>
                                <div style={{padding:"0 30px 0 50px"}}>{questionList[3]["category"]}</div>
                                <div style={{padding:"0 20px 0 10px"}}>{questionList[3]["count"]}건</div>
                                <div style={{padding:"0 10px 0 20px"}}>{Math.floor((questionList[3]["count"]/totalQuestionCount)*100)}%</div>
                            </div>
                            <br />
                        </div>
                    </div>
                            ...
                            <div className='profile-card'>
                                <div className='profile-card-inout'>
                                    <div className="card card-separater">
                                        <div className="card-body" style={{border: '1px solid #303030'}}>
                                            <div className="card-top">
                                                <div className="card-label-wrap">
                                                    <span className="card-label" style={{color: '#F68536'}}>교외활동</span>
                                                    <p className="card-title" style={{color: '#F68536'}}><br />학교 밖에서 이런 것들을 경험해봤으니,<br /> 관련해서 물어봐주셔도 됩니다.</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className="card-body" style={{border: '1px solid #303030'}}>
                                            <div className="card-top">
                                                <div className="card-label-wrap">
                                                    ...
                                                    <p className="card-title" style={{color: '#F68536'}}><br />학교 안에서는, 이런 경험을 해왔어요.</p>
                                                </div>
                                            </div>
                                            <div className="table-wrap">
                                                <table className="table table-borderless table-act mb-0">
                    ...
                    <div className='new-mento-intro' style={{background:'#F68536'}}>
                        <div className='intro-card'>
                            <br />
                    ...
                    <div className="container-fluid" style={{display: 'flex', justifyContent: 'center' , alignItems: 'center', flexDirection:'column'}}>
                        <br /><br /><br /><br />
                        <div className="visual-txt" style={{fontSize:'30px'}}>멘토링을 받고싶은 마음이 생겼다면?</div>
                    </div>
                    <div className="container-fluid" >
                        <div className="summary-area">
                            <div className='summary-bottom'>
