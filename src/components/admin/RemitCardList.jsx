...
const RemitCardList = memo(()=>{
    const {setRemitCount} = useContext(TodoListCountContext);
    ...
    const fetchCardListData = async () => {
        try {
            const response = await axios.get(`/back/admin/endedMentoring`,{
            headers: {
        ...
        const fetchData = async () => {
            try {
                if(!confirm(
                    ...
                    console.log("멘토 송금 완료 체크 작업이 취소되었습니다.");
                    return false;
                }
                const response = await axios.put(`/back/admin/mentoring/${id}`,{}, {
                    headers: {
                        'Authorization': `Bearer ${token}`
                    }
                });
        ...
        <>
            <div className="card-list-wrap" id="remit">
                <div className="card-title-wrap">
                    ...
                    <p className="discript">멘토에게 송금해주는 작업 필요</p>
                </div>
                    ...
                    <div className="card deposit-card" key={card.mentoringId}>
                        <div className="card-body">
                            ...
                            <div className="btns-wrap-hr">
                                ...
                                <button className="btn btn-primary" onClick={() => handleBtnDeposit(card.mentoringId)}>송금 완료</button>
                            </div>
                        </div>
                    </div>
                ))}
